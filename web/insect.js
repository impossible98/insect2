...
(function($PS) {
  ...
  var $$void = function (dictFunctor) {
      return map(dictFunctor)(Data_Functor._const(Data_Unit.unit));
  };
  var voidLeft = function (dictFunctor) {
      return function (f) {
          return function (x) {
              return map(dictFunctor)(Data_Functor._const(x))(f);
          };
      };
  };
...
(function($PS) {
  ...
  var applySecond = function (dictApply) {
      return function (a) {
          return function (b) {
              return apply(dictApply)(Data_Functor.map(dictApply.Functor0())(Data_Functor._const(Control_Category.identity(Control_Category.categoryFn)))(a))(b);
          };
      };
  };
...
(function($PS) {
  ...
  var isRight = either(Data_Functor._const(false))(Data_Functor._const(true));
          ...
          return function (f) {
              return function (a0) {
                  return foldl(dictFoldable)(function (ma) {
                      return function (b) {
                          return Control_Bind.bind(dictMonad.Bind1())(ma)(Data_Functor.flip(f)(b));
                      };
...
(function($PS) {
  ...
  var isNothing = maybe(true)(Data_Functor._const(false));
  var isJust = maybe(false)(Data_Functor._const(true));
...
(function($PS) {
  ...
  var uncons = $foreign["uncons'"](Data_Functor._const(Data_Maybe.Nothing.value))(function (x) {
      return function (xs) {
...
(function($PS) {
  ...
  var foldableList = new Data_Foldable.Foldable(function (dictMonoid) {
      ...
      return function (b) {
          var rev = Data_Foldable.foldl(foldableList)(Data_Functor.flip(Cons.create))(Nil.value);
          var $204 = Data_Foldable.foldl(foldableList)(Data_Functor.flip(f))(b);
          return function ($205) {
              return $204(rev($205));
          };
      };
  ...
  var traversableList = new Data_Traversable.Traversable(function () {
      ...
      return function (f) {
          var $219 = Data_Functor.map((dictApplicative.Apply0()).Functor0())(Data_Foldable.foldl(foldableList)(Data_Functor.flip(Cons.create))(Nil.value));
          var $220 = Data_Foldable.foldl(foldableList)(function (acc) {
              var $222 = Control_Apply.lift2(dictApplicative.Apply0())(Data_Functor.flip(Cons.create))(acc);
              return function ($223) {
                  return $222(f($223));
              };
...
(function($PS) {
  ...
  var keys = (function () {
      var $0 = Data_Functor._void(Data_Map_Internal.functorMap);
      return function ($1) {
          return $0($1);
      };
  })();
...
(function($PS) {
  ...
  var splitByDimension = function (v) {
      ...
      var reduce = function (us$prime) {
          var us = sortBy$prime(Data_Functor.flip(heuristic))(us$prime);
      ...
      var transform = (function () {
          ...
          var $235 = groupBy$prime(Data_Functor.on(Data_Eq.eq(eqDerivedUnit))(standardUnitWithoutExponent));
          return function ($236) {
              return $234($235($236));
          };
      })();
...
(function($PS) {
  ...
  var convertTo = Data_Functor.flip(convert);
  var qAdd = function (v) {
      return function (v1) {
          if (Data_Eq.eq(Data_Decimal.eqDecimal)(v.value0)(Data_Semiring.zero(Data_Decimal.semiringDecimal))) {
...
(function($PS) {
  ...
  var conversionErrorMessage = function (v) {
      var baseRep = function (u) {
          ...
          var usStrs = Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidArray)([ Insect_Format.text("\xb7") ])(Data_Functor.map(Data_List_Types.functorList)(function ($139) {
          ...
          var $41 = Data_Eq.eq(Data_Units.eqDerivedUnit)(Data_Tuple.fst(Data_Units.toStandardUnit(u)))(Data_Units.unity);
          if ($41) {
              return [  ];
          };
          var $42 = Data_Units.toString(u) === Insect_Format.format(Insect_Format.fmtPlain)(usStrs);
          if ($42) {
              return [  ];
          };
          return br;
      };
      var $43 = Data_Eq.eq(Data_Units.eqDerivedUnit)(v.value0)(Data_Units.unity);
      if ($43) {
      ...
      var $44 = Data_Eq.eq(Data_Units.eqDerivedUnit)(v.value1)(Data_Units.unity);
      if ($44) {
      ...
      return function (v) {
          ...
          if (v instanceof Insect_Language.Factorial) {
              return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v.value0))((function () {
                  var $140 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Insect_Language.QConversionError.create);
                  return function ($141) {
          ...
          if (v instanceof Insect_Language.Apply) {
              var $80 = v.value0 === "sum" || v.value0 === "product";
              if ($80) {
  ...
  var runInsect = function (env) {
      return function (v) {
          ...
          if (v instanceof Insect_Language.VariableAssignment) {
              ...
              if (v1 instanceof Data_Either.Right) {
                  var $115 = isConstant(env)(v.value0);
                  if ($115) {
          ...
          if (v instanceof Insect_Language.FunctionAssignment) {
              ...
              var fAssign = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Insect_Format["function"](v.value0), Insect_Format.text("(") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(fArgs)([ Insect_Format.text(") = ") ]));
              ...
              var $124 = isConstant(env)(v.value0);
              if ($124) {
          ...
          if (v instanceof Insect_Language.Command && v.value0 instanceof Insect_Language.List) {
              ...
              var toLine = function (kvPairs) {
                  ...
                  var identifiers = Data_Array.fromFoldable(Data_Foldable.foldableArray)(Data_Foldable.intercalate(Data_List_Types.foldableNonEmptyList)(Data_Monoid.monoidArray)([ Insect_Format.text(" = ") ])(Data_Functor.map(Data_List_Types.functorNonEmptyList)(function ($142) {
              ...
              var envTuples = Data_List.sortBy(Data_Ord.comparing(Data_Ord.ordString)(function ($143) {
                  return (function (v1) {
                      return v1.number;
              ...
              var envSorted = Data_List.sortBy(Data_Ord.comparing(Data_Ord.ordString)(function ($144) {
...
(function($PS) {
  ...
  var inCommentMulti = function (dictMonad) {
      return function (v) {
          var startEnd = Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_String_CodeUnits.toCharArray(v.commentEnd))(Data_String_CodeUnits.toCharArray(v.commentStart));
          return Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (p) {
              return Text_Parsing_Parser_Combinators.withErrorMessage(dictMonad)(Control_Alt.alt(Text_Parsing_Parser.altParserT(dictMonad))(Control_Alt.alt(Text_Parsing_Parser.altParserT(dictMonad))(Control_Alt.alt(Text_Parsing_Parser.altParserT(dictMonad))(Data_Functor._void(Text_Parsing_Parser.functorParserT(((dictMonad.Bind1()).Apply0()).Functor0()))(Text_Parsing_Parser_Combinators["try"](dictMonad)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(dictMonad)(v.commentEnd))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(dictMonad))(multiLineComment(dictMonad)(v))(p)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(dictMonad))(Text_Parsing_Parser_Combinators.skipMany1(dictMonad)(Text_Parsing_Parser_String.noneOf(Text_Parsing_Parser_String.stringLikeString)(dictMonad)(startEnd)))(p)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(dictMonad))(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(dictMonad)(startEnd))(p)))("end of comment");
          });
      };
  };
...
(function($PS) {
  ...
  var commands = [ "help", "?", "list", "ls", "ll", "reset", "clear", "cls", "quit", "exit" ];
  var insectLanguage = {
      commentStart: "",
      commentEnd: "",
      commentLine: "#",
  ...
  var number = (function () {
      var fromCharArray = (function () {
          var $42 = Data_Functor.map(Data_Functor.functorArray)(Data_String_CodePoints.codePointFromChar);
          return function ($43) {
          ...
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optionMaybe(Data_Identity.monadIdentity)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Semigroup.append(Data_Semigroup.semigroupString))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".")))(digits)))(function (mFracPart) {
              ...
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optionMaybe(Data_Identity.monadIdentity)(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("e"))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(whiteSpace)(function () {
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var $23 = Data_Decimal["isFinite"](v.value0);
                          if ($23) {
