                ...
                while (Data_Functor.map(Control_Monad_ST_Internal.functorST)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Control_Monad_ST_Internal.read($$break))()) {
                    (function __do() {
                        ...
                        if (mx instanceof Data_Maybe.Just && p(mx.value0)) {
                            ...
                            return Data_Functor._void(Control_Monad_ST_Internal.functorST)(next(iter))();
                        };
                        return Data_Functor._void(Control_Monad_ST_Internal.functorST)(Control_Monad_ST_Internal.write(true)($$break))();
                    })();
                };
                return {};
            };
...
let pushAll = pushWhile(Data_Functor._const(true));
...
let exhausted = (function () {
    let $13 = Data_Functor.map(Control_Monad_ST_Internal.functorST)(Data_Maybe.isNothing);
    return function ($14) {
        return $13(peek($14));
    };
})();
