...
let makeTimeout = function (time) {
    return control.discard(control.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(Milliseconds(toNumber(time))))(function () {
...
let walkSuite = function (runItem) {
    return function (tests) {
        return control.bind(Effect_Aff.bindAff)(Effect_Aff_AVar["new"](Data_List_Types.Nil.value))(function (coll) {
            let walkItem = function (path) {
                return function (v) {
                    if (v instanceof TestGroup) {
                        return control.discard(control.discardUnit)(Effect_Aff.bindAff)(runItem(path)(new Data_Either.Left(v.value0.value0)))(function () {
                            return control.discard(control.discardUnit)(Effect_Aff.bindAff)(Control_Monad_Free.runFreeM(functorTestF)(Effect_Aff.monadRecAff)(walkItem(Data_List.snoc(path)(v.value0.value0)))(v.value0.value1))(function () {
                    ...
                    if (v instanceof TestUnit) {
                        return control.bind(Effect_Aff.bindAff)(Effect_Aff.suspendAff(v.value3))(function (fiber) {
                            return control.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.take(coll))(function (cs) {
                                return control.discard(control.discardUnit)(Effect_Aff.bindAff)(Effect_Aff_AVar.put(new Data_List_Types.Cons(Data_Tuple.Tuple.create(Data_List.snoc(path)(v.value0))(Effect_Aff.joinFiber(fiber)), cs))(coll))(function () {
                                    return control.discard(control.discardUnit)(Effect_Aff.bindAff)(runItem(path)(Data_Either.Right.create(Data_Tuple.Tuple.create(v.value0)(Effect_Aff.joinFiber(fiber)))))(function () {
            ...
            return control.discard(control.discardUnit)(Effect_Aff.bindAff)(Control_Monad_Free.runFreeM(functorTestF)(Effect_Aff.monadRecAff)(walkItem(Data_List_Types.Nil.value))(tests))(function () {
...
let countSkippedTests = function (ts) {
    let go = function (v) {
...
let collectResults = function (tests) {
    let run = function (v) {
