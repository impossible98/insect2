...
let ConversionRule = function (x) {
	return x;
};
let CharBlock = function (x) {
	return x;
};
let showUnicodeCategory = new Data_Show.Show(function (v) {
...
let showConversionRule = new Data_Show.Show(function (v) {
...
let showCharBlock = new Data_Show.Show(function (v) {
...
let numSpaceBlocks = 8;
let numRules = 167;
let numLat1Blocks = 63;
let numConvBlocks = 1230;
let numBlocks = 2783;
let maxUniChar = 1114109;
let gencatZS = 2;
let rule1 = {
	category: gencatZS,
				...
				let go = function ($copy_i) {
					return function ($copy_k) {
						...
						function $tco_loop(i, k) {
							...
							if (true) {
								let j = floor(toNumber(i + k | 0) / 2.0);
								let v = compare(a)(array[j]);
...
let getRule = function (blocks) {
	return function (unichar) {
		return function (size) {
			...
			let maybeCharBlock = bsearch(key)(blocks)(size)(blkCmp);
...
let uTowlower = caseConv(function (v) {
	return v.lowdist;
});
let uTowtitle = caseConv(function (v) {
	return v.titledist;
});
let uTowupper = caseConv(function (v) {
	return v.updist;
});
let checkAttrS = function (categories) {
	return function ($$char) {
		...
		if (maybeConversionRule instanceof Data_Maybe.Just) {
			return Data_Maybe.isJust(Data_Array.elemIndex(eqInt)(maybeConversionRule.value0.category)(categories));
		};
...
let uIswspace = checkAttrS([gencatZS]);
let allchars = [{
	start: 0,
	length: 32,
	convRule: rule0
...
let checkAttr = function (categories) {
	return function ($$char) {
		let numOfBlocks = (() => {
			let $28 = $$char < 256;
			if ($28) {
		...
		let maybeConversionRule = getRule(allchars)($$char)(numOfBlocks);
		if (maybeConversionRule instanceof Data_Maybe.Nothing) {
			return false;
		};
		if (maybeConversionRule instanceof Data_Maybe.Just) {
...
let uIswalnum = checkAttr([gencatLT, gencatLU, gencatLL, gencatLM, gencatLO, gencatMC, gencatME, gencatMN, gencatNO, gencatND, gencatNL]);
let uIswalpha = checkAttr([gencatLL, gencatLU, gencatLT, gencatLM, gencatLO]);
let uIswcntrl = checkAttr([gencatCC]);
let uIswdigit = checkAttr([gencatND]);
let uIswlower = checkAttr([gencatLL]);
let uIswprint = checkAttr([gencatMC, gencatNO, gencatSK, gencatME, gencatND, gencatPO, gencatLT, gencatPC, gencatSM, gencatZS, gencatLU, gencatPD, gencatSO, gencatPE, gencatPF, gencatPS, gencatSC, gencatLL, gencatLM, gencatPI, gencatNL, gencatMN, gencatLO]);
