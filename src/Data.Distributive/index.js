...
let distributiveIdentity = new Distributive(function () {
    ...
    return function (f) {
        let $11 = Data_Functor.map(dictFunctor)((function () {
    ...
    let $15 = Data_Functor.map(dictFunctor)(Data_Newtype.unwrap(Data_Identity.newtypeIdentity));
    return function ($16) {
...
let distributiveFunction = new Distributive(function () {
    ...
    return function (f) {
        ...
        let $18 = Data_Functor.map(dictFunctor)(f);
        return function ($19) {
            return $17($18($19));
        };
    };
...
let cotraverse = function (dictDistributive) {
    return function (dictFunctor) {
        return function (f) {
            let $20 = Data_Functor.map(dictDistributive.Functor0())(f);
...
let collectDefault = function (dictDistributive) {
    return function (dictFunctor) {
        return function (f) {
            ...
            let $24 = Data_Functor.map(dictFunctor)(f);
            return function ($25) {
                return $23($24($25));
            };
        };
