...
let in1 = Data_Either.Left.create;
let either9 = function (a) {
    return function (b) {
        return function (c) {
            return function (d) {
                return function (e) {
