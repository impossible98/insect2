...
let Data_String_Regex_Flags = require("../Data.String.Regex.Flags/index.js");
let showRegex = new Data_Show.Show($foreign["showRegex'"]);
let search = $foreign["_search"](Data_Maybe.Just.create)(Data_Maybe.Nothing.value);
let renderFlags = function (v) {
    return (function () {
        if (v.value0.global) {
            return "g";
        };
...
let match = $foreign["_match"](Data_Maybe.Just.create)(Data_Maybe.Nothing.value);
let flags = function ($8) {
